...
import { useDispatch } from "react-redux";
 import * as actions from "../../../redux/actions/mettrejourinscription/mettrejourinscription"



function Mettrejourinscription(){
  ...
  const onFinish = (values) => {
          mettrejourInscription( values.email, values.cod )
        };

        const mettrejourInscription = (email, code) => {
          console.log(email, code)
          dispatch(actions.mettrejourInscription({ email, code}))}
    return (
    
        <div style={{padding: 10, margin: 60}}>
            <h1 style={{color:"red"}}>Mettre À Jour Mon Inscription</h1>
